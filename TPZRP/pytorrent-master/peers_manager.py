...
class PeersManager(Thread):
    ...
    def get_random_peer_having_piece(self, index):
        ...
        for peer in self.peers:
            #print(f"{peer.is_eligible()} {peer.is_unchoked()} {peer.am_interested()} {peer.has_piece(index)}")
            if peer.is_eligible() and peer.is_unchoked() and peer.has_piece(index) and peer.am_interested():
